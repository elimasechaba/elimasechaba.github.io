	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
			<head>
				...
				<xsl:variable name="tableMinWidth" select="'727'"/><xsl:variable name="colorMain" select="'#222222'"/><xsl:variable name="colorAccent" select="'#00a0d2'"/><xsl:variable name="relativeFontColor" select="'#ffffff'"/><title>XML Sitemap - eli masechaba</title>
...
<link rel="icon" href="/wp-content/uploads/2026/05/cropped-eli-1-32x32.png" sizes="32x32" />
<link rel="icon" href="/wp-content/uploads/2026/05/cropped-eli-1-192x192.png" sizes="192x192" />
<link rel="apple-touch-icon" href="/wp-content/uploads/2026/05/cropped-eli-1-180x180.png" />
<meta name="msapplication-TileImage" content="/wp-content/uploads/2026/05/cropped-eli-1-270x270.png" />
			</head>
			<body class="ltr">
				<div id="description">
					<div class="wrap">
						<a href="/"><h1><img src="/wp-content/uploads/2026/05/cropped-eli-1-32x32.png" width="29" height="29" />eli masechaba — XML Sitemap</h1></a>
<p>
...
<p>
	You can find more information on XML sitemaps at <a href="https://www.sitemaps.org/" target="_blank" rel="nofollow noreferrer noopener">sitemaps.org</a>.</p>
					</div>
				</div>
				<div id="content">
					<div class="wrap">
